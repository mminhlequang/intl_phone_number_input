...
class InternationalPhoneNumberInput extends StatefulWidget {
  ...
  final Widget Function({
    ...
    required InputDecoration? searchBoxDecoration,
    required bool autoFocusSearchField,
...
class _InputWidgetState extends State<InternationalPhoneNumberInput> {
  ...
  Widget get selectorButton => widget.builderSelectionButton != null
      ? widget.builderSelectionButton!(
          country: country,
          countries: countries,
